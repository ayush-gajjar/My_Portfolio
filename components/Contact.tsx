  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row gap-8 justify-center items-stretch">
        {/* Resume Download Card with Profile (left side) */}
        <motion.div 
        ...
        >
          ...
          <div className="flex-grow flex flex-col justify-center">
            ...
            <div className="flex flex-col space-y-3">
              <Button
                className="bg-indigo-500 hover:bg-indigo-600 text-white transition-all hover:scale-[1.02]"
              >
                <a 
                  href="/Ayush/resume-ayushgajjar.pdf" 
                  download="AyushGajjar_Resume.pdf"
                  className="w-full"
                >
                  Download PDF
                </a>
